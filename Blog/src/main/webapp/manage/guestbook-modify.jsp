...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>回复留言</h2>
		<div class="manage">
			<form action="update.cuba" method="post">
				<table >
				<input type="hidden" name="id" value="${list.BU_ID }">
					<tr>
						<td class="field">回复留言：</td>
						<td><input type="text" class="text" name="BUCONTENT" value="${list.BUCONTENT }" /></td>
					</tr>
