...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>新增用户</h2>
		<div class="manage">
			<form action="save.abcd"  method="post">
				<table class="form">
					
					<tr>
						<td class="field">姓名：</td>
						<td><input type="text"  name="bu_user_name"  /></td>
					</tr>
					<tr>
						<td class="field">密码：</td>
						<td><input type="text"  name="bu_password" /></td>
					</tr>
					<tr>
						<td class="field">性别：</td>
						<td><input type="text"  name="bu_sex"  /> 
						
					</tr>
					
					<tr>
						<td class="field">手机号码：</td>
						<td><input type="text"  name="bu_mobile"  /></td>
					</tr>
					<tr>
						<td class="field">邮箱：</td>
						<td><input type="text"  name="bu_email" /></td>
					</tr>
