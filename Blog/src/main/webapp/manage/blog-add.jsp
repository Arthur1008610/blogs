...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>添加文章</h2>
		<div class="manage">
			<form action="save.ba" method="post">
				<table class="form">
					<tr>
					...
					<tr>
						...
						<td>
							<select name="parentId">
								<c:forEach var="li" items="${parentList }">
									<option value="${li.bacParentId }">${li.bacName }</option>
								</c:forEach>
							</select>
						</td>
					</tr>				
					<tr>
						...
						<td><input type="text" class="text" name="description"  value="信息描述"/></td>
					</tr>
					<tr>
						<td></td>
