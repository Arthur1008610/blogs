...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改文章</h2>
		<div class="manage">
			<form action="update.ba" method="post">
				<table class="form">
				<input type="hidden" name="id" value="${article.baId }">
					<tr>
						<td class="field">文章标题：</td>
						<td><input type="text" class="text" name="title" value="${article.baTitle }" /></td>
					</tr>
								
					<tr>
						<td class="field">信息描述</td>
						<td><input type="text" class="text" name="description"  value="${article.baDescription }"/></td>
					</tr>
					<tr>
						<td></td>
